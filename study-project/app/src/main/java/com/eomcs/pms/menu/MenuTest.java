...
public class MenuTest {
  ...
  public static void main(String[] args) {
    ...
    boardAddMenu.addActionListner(new BoardAddListener());

    MenuItem boardListMenu = new MenuItem("목록");
    boardListMenu.addActionListner(new BoardListListener());

    MenuItem boardDetailMenu = new MenuItem("상세조회");
    boardDetailMenu.addActionListner(new BoardDetailListener());
