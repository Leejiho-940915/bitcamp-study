...
public class App {
  ...
  public App() {
    ...
    commandMap.put("/member/update", new MemberDetailHandler(memberList));
    ...
    commandMap.put("/project/detail", new ProjectUpdateHandler(projectList, memberPrompt));
    commandMap.put("/project/update", new ProjectDetailHandler(projectList));
    ...
    commandMap.put("/task/detail", new TaskUpdateHandler(projectPrompt));
    commandMap.put("/task/update", new TaskDetailHandler(projectPrompt));
  ...
  Menu createMenuItem() {
    ...
    adminMenu.add(new MenuItem("등록","/task/add"));
    adminMenu.add(new MenuItem("목록", "/task/list"));
    adminMenu.add(new MenuItem("상세보기", "/task/detail"));
    adminMenu.add(new MenuItem("변경","/task/update"));
    adminMenu.add(new MenuItem("삭제","/task/delete"));
